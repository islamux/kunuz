...
export const CHAPTERS: Chapter[] = [
  {
    id: 'daily-dhikr',
    name: 'أذكار اليوم والليلة وجوامع التسبيح',
  ...
  {
    id: 'prayers-mosques',
    name: 'صلوات النوافل وفضائل الفرائض والمساجد',
  ...
  },
  {
    ...
    name: 'كفارات الذنوب وموجبات الجنة والتوبة',
  ...
  {
    id: 'relief-ruqyah',
    name: 'تفريج الكروب وقضاء الديون والرقية الشرعية',
  ...
  {
    id: 'quran-virtues',
    name: 'فضائل القرآن الكريم وسوره وآياته',
  ...
  {
    id: 'morals-relations',
    name: 'مكارم الأخلاق وحقوق المسلمين وصلة الأرحام',
  ...
  {
    id: 'charity-ongoing',
    name: 'الصدقات والأجور الجارية المتعدية',
  ...
  {
    id: 'fasting-seasons',
    name: 'الصيام والفضائل والنفحات الموسمية',
  ...
  {
    id: 'manners-sunan',
    name: 'الآداب النبوية والسنن العملية المهجورة',
